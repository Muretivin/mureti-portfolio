...
function Geometries () {
    ...
    const soundEffects =[
        ...
        new Audio("/sounds/highDown.ogg"),
        new Audio("/sounds/mouserelease1.ogg"),
        new Audio("/sounds/rollover3.ogg"),
        new Audio("/sounds/switch37.ogg"),
    ];
...
function Geometry ({r, position, geometry, materials, soundEffects}){
    ...
    const handlePointerOver = () =>{
        document.body.style.coursor = "pointer"
    }
    const handlePointerOut = () =>{
        document.body.style.coursor = "default"
    }
